nummer = [798, 1976, 1866, 1862, 559, 1797, 1129, 747, 85, 1108, 104, 2000, 248, 131, 87, 95,
...
i = 1
index = 0
while i < 16 and index < 256:
    row_max = max(nummer[index], nummer[index + 1], nummer[index + 2], nummer[index + 3], nummer[index + 4],
                  nummer[index + 5], nummer[index + 6], nummer[index + 7], nummer[index + 8], nummer[index + 9],
                  nummer[index + 10], nummer[index + 11], nummer[index + 12], nummer[index + 13], nummer[index + 14],
                  nummer[index + 15])
    row_min = min(nummer[index], nummer[index + 1], nummer[index + 2], nummer[index + 3], nummer[index + 4],
                  nummer[index + 5], nummer[index + 6], nummer[index + 7], nummer[index + 8], nummer[index + 9],
                  nummer[index + 10], nummer[index + 11], nummer[index + 12], nummer[index + 13], nummer[index + 14],
                  nummer[index + 15])
    index = index + 16
    row_done = row_max - row_min
    total_sum = total_sum + row_done
print(total_sum)
